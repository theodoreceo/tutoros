...
const students = [
  ...
  { id:'s1',  name:'Иванова Мария',       contact:'@masha_ivanova',  grade:'11', group_id:'g1', format:'group',      crm_status:'active',          price_per_hour:2500, lessons_per_month:8, paid:true,  subscription_type:'3month', trial_score:52, target_score:80,  source:'Авито',    notes:'Очень старательная, всегда делает домашку. Нужно усилить тему интегралов.',        created_at:'2025-09-05T10:00:00Z', first_contact_at:'2025-09-03', left_at:null,            status_history: hist(['lead','2025-09-03'],['trial_scheduled','2025-09-06'],['trial_done','2025-09-10'],['active','2025-09-12']) },
  { id:'s2',  name:'Петров Артём',        contact:'+79161234567',    grade:'11', group_id:'g1', format:'group',      crm_status:'active',          price_per_hour:2500, lessons_per_month:8, paid:true,  subscription_type:'3month', trial_score:61, target_score:85,  source:'Сарафан',  notes:'Хорошо разбирается в алгебре, геометрия слабее.',                                  created_at:'2025-09-08T10:00:00Z', first_contact_at:'2025-09-07', left_at:null,            status_history: hist(['lead','2025-09-07'],['trial_done','2025-09-11'],['active','2025-09-15']) },
  { id:'s3',  name:'Новикова Дарья',      contact:'@dasha_nov',      grade:'11', group_id:'g1', format:'group',      crm_status:'active',          price_per_hour:2500, lessons_per_month:8, paid:true,  subscription_type:'3month', trial_score:48, target_score:75,  source:'ВКонтакте',notes:'Готовится к профильному ЕГЭ. Слабое место — тригонометрия.',                         created_at:'2025-09-10T10:00:00Z', first_contact_at:'2025-09-09', left_at:null,            status_history: hist(['lead','2025-09-09'],['trial_done','2025-09-14'],['active','2025-09-18']) },
  ...
  // ── ACTIVE (individual) ──
  { id:'s21', name:'Сидорова Анна',       contact:'@sidorova_anya',  grade:'11', group_id:null, format:'individual', crm_status:'active',          price_per_hour:3500, lessons_per_month:6, paid:true,  subscription_type:'3month', trial_score:44, target_score:75,  source:'Авито',    notes:'Готовится к профильной математике. Слабое место — задания на геометрию (часть 2).', created_at:'2025-09-12T10:00:00Z', first_contact_at:'2025-09-11', left_at:null,            status_history: hist(['lead','2025-09-11'],['trial_done','2025-09-15'],['active','2025-09-18']) },
  ...
  { id:'s23', name:'Павлова Светлана',    contact:'@sveta_pavlova',  grade:'11', group_id:null, format:'individual', crm_status:'active',          price_per_hour:4000, lessons_per_month:8, paid:true,  subscription_type:'6month', trial_score:65, target_score:95,  source:'Сарафан',  notes:'Призёр олимпиады. Готовится на 100 баллов ЕГЭ.',                                   created_at:'2025-10-15T10:00:00Z', first_contact_at:'2025-10-14', left_at:null,            status_history: hist(['lead','2025-10-14'],['trial_done','2025-10-17'],['active','2025-10-20']) },
...
const payments = (() => {
  ...
  pay('s1', daysAgo(12), 20000,'СБП', 82);      pay('s2', daysAgo(10), 20000,'Перевод', 78);
  pay('s3', daysAgo(9),  20000,'СБП', 75);      pay('s5', daysAgo(11), 20000,'Наличные', 19);
  pay('s21',daysAgo(8),  21000,'СБП', 83);      pay('s23',daysAgo(6),  32000,'Перевод', 165);
